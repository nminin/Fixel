...
class HelpInfoImageViewHolder(view: View, style: Style) : StyledViewHolder<HelpInfo>(view, style) {
    ...
    override fun bind(
        ...
        with(itemView.findViewById<RecyclerView>(R.id.item_recycler)) {
            ...
            this.adapter = this@HelpInfoImageViewHolder.adapter
        }
        item.images?.let {
