...
class HelpInfoBackgroundImageColoredViewHolder(view: View, style: Style): StyledViewHolder<HelpInfo>(view, style) {
    private var isVisible = false

    companion object {
        fun create(parent: ViewGroup, layout: Int = R.layout.item_help_background_image_colored, style: Style) =
            HelpInfoBackgroundImageColoredViewHolder(
